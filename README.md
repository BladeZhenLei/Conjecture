...
<br/> All elements in the set of even numbers {2, 4, 6, ..., n} can be expressed as infinitely many consecutive primes. In other words, the 2-tuple $(0,k)$ takes all even numbers for $k$.  
<br/>
<strong> Comment </strong>
<br/>
.
